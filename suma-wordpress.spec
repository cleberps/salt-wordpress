Name:           suma-wordpress-formula
Version:        0.1
Release:        1%{?dist}
Summary:        Wordpress Deployment Formula for SUSE Manager
...
%define fname suma-wordpress
%define fdir  %{_datadir}/salt-formulas

%description
Wordpress Deployment Formula for SUSE Manager.

%prep
%setup -q -n suma-wordpress
